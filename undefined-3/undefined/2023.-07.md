...
* [ ] [온보딩](https://fistkim.atlassian.net/jira/software/projects/FSQD/boards/3?selectedIssue=FSQD-11)(15:20 \~&#x20;
  * [ ] view, viewmodel(bloc, state, event) 정의
  * [ ] view 구현 및 view <-> viewmodel 로직 구현
  * [ ] viewmode <-> server 구현
    * [ ] 온보딩 API(서버 백로그
...
* [ ] [로그인 및 회원가입](https://fistkim.atlassian.net/jira/software/projects/FSQD/boards/3?selectedIssue=FSQD-10)
