...
* [ ] 디자인 패턴(09:00 \~
* [ ] [로그인 및 회원가입](https://fistkim.atlassian.net/jira/software/projects/FSQD/boards/3?selectedIssue=FSQD-10) (어제 틀 다 잡아두었으니 신속하게 1.5h 안에 완료하기)
  * [ ] bloc 내부 로직 구현 및 로그인 서드파티 연결
    * [ ] 카카오 로그인
    * [ ] 애플 로그인
