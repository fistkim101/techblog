...
* [ ] [온보딩](https://fistkim.atlassian.net/jira/software/projects/FSQD/boards/3?selectedIssue=FSQD-11)(10:00 \~
  * [x] 완료화면 구현 및 이동처리(10:00 \~ 11:00)
  * [ ] viewmode <-> server 구현(11:00 \~&#x20;
    * [ ] data layer 로직 구현 및 viewmodel, view 로직 처리(앱쪽에 필요한 모든 구현 완료)\
