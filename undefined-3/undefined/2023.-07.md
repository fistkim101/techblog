...
* [ ] 홈-나의 식단, 식단 추가(10:30 \~
  * [x] 바텀 메뉴 위젯 구조 다시 파악 후 화면 스택 설계(서브메뉴 등 어떻게 할지)(10:30 \~ 12:30)
  * [ ] 설계에 맞춰서 go\_router 관련 작업. 홈메뉴 관련 모든 화면 라우터 작업완료
  * [ ] view, viewmodel 구조잡기(bloc 정의 및 event, state 정의)(view 구조는 그룹식단까지)
  * [ ] view 구현
* [ ] 홈-나의 식단, 식단 추가 관련 서버 백로그 리스트업
...
* [x] [온보딩](https://fistkim.atlassian.net/jira/software/projects/FSQD/boards/3?selectedIssue=FSQD-11)
* [ ] 홈
  * [ ] 나의 식단
    * [ ] 식단 목록 조회
    * [ ] 식단 상세 조회
