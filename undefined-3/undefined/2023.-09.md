...
* [ ] 무조건 선순위 처리 Task
  * [x] 알고리즘 복습 CH01, CH02
  * [x] 알고리즘 진도 CH06
  * [ ] JAVA 인터뷰 질문 5 개 이상 블로그 정리 후 QuizMind 카드화
...
* [ ] 무조건 선순위 처리 Task
  ...
  * [ ] 이펙티브 자바 아이템 2개
  * [ ] JAVA 인터뷰 질문 5 개 이상 블로그 정리 후 QuizMind 카드화
* [ ] 스프링 입문을 위한 자바 객체 지향의 원리와 이해 CH03 \~ CH05 QuizMind 카드화
* [ ] QuizMind, FitSquad 멀티 태스크 화면에서 아이콘 예전꺼 나오는거 버그 픽스
* [ ] QuizMind 유닛 생성시 카테고리 로딩시 로딩 스피너 처리하기
* [ ] FitSquad 심사 거절 요건 1h 내 픽스하고 재심사 요청하기
