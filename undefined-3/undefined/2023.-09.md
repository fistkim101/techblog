...
* [ ] 알고리즘 CH08(2/2) (꼭 알고리즘을 먼저!)
* [ ] 알고리즘 CH9
* [ ] 이펙티브 자바 아이템 2개
* [ ] (09/21 백로그 밀린 것) 이펙티브 자바 아이템 2개
* [ ] QuizMind 카드 처리
...
* [ ] (09/22 백로그 밀린 것)
  * [ ] 이펙티브 자바 아이템 1개
  * [ ] JAVA 인터뷰 질문 3 개 이상 블로그 정리 후 QuizMind 카드화
* [ ] QuizMind 카드 처리
...
### 임시 스프린트(완료 후 아래 삭제) (**\~ 10/03)**

* [x] QuizMind 심사 통과(두 마켓 모두) 후 내용 추가(3개 up)(ASAP)
* [ ] 인프런 알고리즘 강의(자바 알고리즘 입문) 완강(\~ 09/25 월)
* [ ] JAVA 아래 내용 정리해서 데일리 토픽으로 정리 및 QuizMind 카드화(\~10/03)
