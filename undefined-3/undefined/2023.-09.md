...
* [ ] QuizMind 심사 통과(두 마켓 모두) 후 내용 추가(3개 up)(ASAP)
* [ ] 인프런 알고리즘 강의(자바 알고리즘 입문) 완강(\~ 09/23 토)
...
* [ ] F-Lab 멘토링 관련 스터디(현재 이펙티브 자바)(하루에 아이템 2개)
* [ ] 블로그에 정리한 내용들 QuizMind 로 카드 작성하며 마스터
* [ ] 인프런 알고리즘 후속 강의 수강(it 대기업 유제)
