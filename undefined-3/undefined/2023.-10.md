...
* [ ] 데일리 Task
  ...
  * [ ] 이펙티브 자바(2h)
  * [ ] 클린 아키텍처
* [ ] 프로그래머스 응시(300min limit)
* [ ] 구 프로젝트 2개 서버 구조 짜서 문서화하기, 유스케이스 각각 정의하고 흐름에 맞게 플로우 도식화해서 피드백 받기(1/2)
* [ ] 신규 프로젝트 기획(1/3)
...
* [ ] 데일리 Task
  ...
  * [ ] 이펙티브 자바(1h)
  * [ ] 클린 아키텍처
* [ ] 구 프로젝트 2개 서버 구조 짜서 문서화하기, 유스케이스 각각 정의하고 흐름에 맞게 플로우 도식화해서 피드백 받기(2/2)
* [ ] 신규 프로젝트 기획(2/3)
