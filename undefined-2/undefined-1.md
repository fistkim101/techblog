...
* (강의) 스프링 부트 개념과 활용(정리는 가급적 안하는 것으로)
* 구 블로그 개념 및 강의 등 전반적으로 안가져온 것들 전체 검토후 가져오기
* (강의) NEXTSTEP 인프라공방
* (강의) NEXTSTEP 스프링 3기
* (강의) 스프링 웹 MVC(2day 넘기지 않도록)
* (강의) 스프링 시큐리티(2day 넘기지 않도록)
* (강의) 더 자바, 애플리케이션을 테스트하는 다양한 방법(2day 넘기지 않도록,  기존 정리 노트 적극 활용해서 시간 아끼기,  라이프 사이클 부분 특히 살펴보기)
* (강의) 더 자바, 코드를 조작하는 다양한 방법(2day 넘기지 않도록,  기존 정리 노트 적극 활용해서 시간 아끼기)
* (강의) 스프링 핵심 원리 - 고급편
