...
보통의 로직이나 클래스를 '종단'으로 보기 때문이다. 일반적으로 코드가 위에서 아래로 순차적으로 진행되기 때문에 어디에나 공통적으로 적용 되는(=적용 시키고 싶은) 관심사는 '횡단'관심사 라고 말하는 것이 합리적이다.



## AOP 적용방법

아래 JVM 구성 및 흐름을 보면서 AOP 적용 타임을 더 잘 인지하자.
